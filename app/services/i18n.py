...
T: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "tr_q_belt": "🥋 Какой у тебя пояс? (белый / синий / фиолетовый / коричневый / чёрный)",
    ...
    "en": {
        ...
        "tr_q_belt": "🥋 What's your belt? (white / blue / purple / brown / black)",
    ...
    "es": {
        ...
        "tr_q_belt": "🥋 ¿Cuál es tu cinturón? (blanco / azul / violeta / marrón / negro)",
    ...
    "pt": {
        ...
        "tr_q_belt": "🥋 Qual é a sua faixa? (branca / azul / roxa / marrom / preta)",
